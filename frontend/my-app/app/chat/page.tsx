...
import { Send, Home, Heart, ArrowLeft, Bot, User, FileText } from "lucide-react"
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex h-screen">
        <div className="w-1/2 border-r border-border flex flex-col">
          ...
          <div className="p-4 border-b border-border bg-card light-shadow dark:dark-glow">
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-xl font-serif font-bold">Research Assistant</h1>
            </div>
            <p className="text-sm text-muted-foreground">General academic research assistance and paper discovery</p>
          </div>
        ...
        <div className="w-1/2 flex flex-col">
          {/* Chat Header */}
          <div className="p-4 border-b border-border bg-card light-shadow dark:dark-glow">
            <h1 className="text-xl font-serif font-bold mb-1">CiteSight AI</h1>
            <p className="text-sm text-muted-foreground">General Research Assistant</p>
          </div>
      ...
      <div className="fixed bottom-6 left-20 flex flex-col gap-3 z-50">
        <Button
          onClick={() => router.push("/")}
          size="sm"
